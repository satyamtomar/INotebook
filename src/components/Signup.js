...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://inotebooksatyam.herokuapp.com/api/auth/createuser", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div className="border-3 border-gray-200 rounded-lg px-7 py-7 shadow-md shadow-cyan-500/100 justify-center text-gray-200">
